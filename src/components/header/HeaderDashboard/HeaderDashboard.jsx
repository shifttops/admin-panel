      ...
      <div className={styles.container}>
          ...
          <div className={styles.header__search}>
            <div className={styles.header__searchBox}>
              <input
                ...
                onChange={searchChangeHandler} value={searchValue}
                onBlur={searchBlurHandler} type="text" placeholder="Search..."/>
            </div>
        ...
        <div className={styles.header__icons}>
          ...
          <div className={styles.header__bellWrapper}>
            <ButtonIcon Icon={BellIcon} onClick={notificationClickHandler} onBlur={notificationBlurHandler}/>
