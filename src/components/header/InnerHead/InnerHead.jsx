      ...
      <div className={styles.innerStore__head}>
        ...
        <div className={styles.innerStore__status}>
          <div className={styles.innerStore__wrap}>
            <p className={styles.innerStore__number}>Store ID: {storeInfo.store_id}
            </p>
            <div className={styles.innerStore__buttons}>
              <Button className={statusMapper.find(item => item.name === storeInfo.status)?.className} text={statusMapper.find(item => item.name === storeInfo.status)?.visibleName} Icon={CheckIcon} />
              <Button
                text="Restart"
                Icon={RestartIcon}
        ...
        <div className={styles.innerStore__info}>
          ...
          <p className={styles.innerStore__region}>
            Store type:<span>{storeInfo.type ? storeInfo.type : ''}</span>
          </p>
        </div>
      </div>
    </div>
