...
import logo from "../../images/tatneft.png";
import logoMin from "../../images/tatneft-min.png";
    ...
    <div className={styles.sidebar__wrap}>
      ...
      >
        <img
          ...
          src={isSidebarOpen.get() ? logo : logoMin}
          alt="logo"
        />
        <div className={styles.sidebar__items}>
          <p className={styles.sidebar__title}>Меню</p>
